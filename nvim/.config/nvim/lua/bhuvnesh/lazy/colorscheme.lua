return {
    ...
    --                 transparency = false,
    --             },
    --             -- You can delete it to get original colors.
    --             -- palette = {
    --             --     dawn = {
    --             --         no_bg = '#faf4ed',
    --             --     },
    ...
    --             --     },
    --             -- },
    --             -- Delete the above block between the comments to get the original color.
    --             highlight_groups = {
    ...
    --             background_clear = {
    --                 -- Specify which plugins to clear the background for
    --                 "toggleterm",
    --                 "telescope",
    --                 "renamer",
    --                 "notify",
    ...
    --                 keywords = { italic = false, bold = true },
    --                 -- Background styles. Can be "dark", "transparent" or "normal"
    --                 sidebars = "bold", -- style for sidebars, see below
    --                 floats = "bold",   -- style for floating windows
    --             },
    --             lualine_bold = false,
    --         })
    --         vim.cmd("colorscheme tokyonight")
    ...
    --                     Pmenu = { bg = mocha.surface0, fg = mocha.overlay1 }, -- Set a solid background for Pmenu
    ...
    --         vim.api.nvim_set_hl(0, 'Visual', { bg = '#575268', bold = true})
    --         -- vim.api.nvim_set_hl(0, "Normal", { bg = "none" })
    --         -- vim.api.nvim_set_hl(0, "NormalFloat", { bg = "none" })
    --     end,
    -- },
